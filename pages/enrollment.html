...
<html>
    <head>
        ...
        <meta
          name="description"
          content="Enrollment page of CHEER Lab"
        />
    ...
    <body>
        ...
        <header>
            <nav>
                ...
                <ul>
                    ...
                    <li><a href="/pages/enrollment.html" class="text_hover nextPageLink currentPageLink" >
                        招生招聘</a></li>
                </ul>
            </nav>
        </header>
        <div class="container">
            <section class="side_bar">
                <h1><span class="bold">JOIN</span><span class="light"> US</span></h1>
