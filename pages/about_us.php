        ...
        <div class="container">
            ...
            <section class="content" id="about_us">
                <div id="info">
                    ...
                    <p class="contact split"><img src="../images/icon/contactIcon_phone.svg" alt="phone icon" class="contactIcon">18621098930</p>
                    <p class="contact" onclick="window.location.href='mailto:sainner@sjtu.edu.cn?subject=CHEERlab向您问好&body=有什么想了解的吗？';"><img src="../images/icon/contactIcon_email.svg" alt="email icon" class="contactIcon">sainner@sjtu.edu.cn</p>
                    <p class="contact"><img src="../images/icon/contactIcon_location.svg" alt="address icon" class="contactIcon">上海交通大学闵行校区设计学院402室</p>
