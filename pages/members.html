...
<html>
    <head>
        ...
        <meta
          name="description"
          content="Members page of CHEER Lab"
        />
    ...
    <body>
            ...
            <nav>
                ...
                <ul>
                    ...
                    <li><a href="/pages/news.html" class="text_hover nextPageLink" >
                        最新动态</a></li>
                    <li class="deployable sub3"><a href="/pages/members.html" class="text_hover nextPageLink currentPageLink" >
                        团队成员</a>
                        <ul class="submenu">
                            <li><a href="#" class="text_hover nextPageLink">
                                在职教师</a></li>
        ...
        <div class="container">
            <section class="side_bar">
                <h1><span class="light">TEAM</span><span class="bold"> MEMBERS</span></h1>
